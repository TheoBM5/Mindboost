...
import { getAllCards, getCard, createCard, updateCard, deleteCard, getAllReviewCards, updateReviewCard, getAllCardsAndDate } from '../controllers/card.controller.js';
...
router.get('/decks/info/:deckid/cards/',isAuth, getAllCardsAndDate);
